...
At the time when expedition begins:
	say "The map I got from professor Lapis was important for two reasons. The first was that it fell perfectly in line with rector Wright's vision for the University: it was a forgotten piece of the old wolrd knowledge which could be used to solve real-life problems in cooperation with the government. It was reassuring to know that even if my old mentor didn't like the direction in which the University was going, he was still willing to help his former students succeed. The second was a bit more selfish: the government rewarded scholars who helped it - and when it came to important resources like copper, they paid more than I would ever earn writing about coal mining (or, for that matter, writing about cartographic occultism).
